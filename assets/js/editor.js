...
function openConsole(){
    ...
    $('.snippet-container').css('display', 'none');
    $('.fa-code').removeClass('side-nav-button-active');
}
...
function openSnippet(){
    ...
    if($('.snippet-container').css('display') == 'none'){
        $('.panel-middle').css('width','60%');
        $('.snippet-container').css('display','block');
        $('.fa-code').addClass('side-nav-button-active');
    }else{
        $('.panel-middle').css('width','100%');
        $('.snippet-container').css('display','none');
        $('.fa-code').removeClass('side-nav-button-active');
